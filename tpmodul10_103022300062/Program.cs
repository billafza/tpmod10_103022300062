...
public static class MahasiswaData
{
    public static List<Mahasiswa> dataMahasiswa { get; private set; } = new List<Mahasiswa>
    {
        ...
        new Mahasiswa("Nashbilla Nurfazza", "103022300063"),
        new Mahasiswa("Khansa Aulia Fauzah", "103022300126"),
        new Mahasiswa("Nadya Sekar Rahmawati", "103022300020"),
        new Mahasiswa("Alwin Fahrozi Marbun", "1302204032")
    };
}